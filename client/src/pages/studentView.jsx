    ...
    return (
        <>
                        ...
                        <div className="flex items-center">
                            <div className=" items-center ms-3">
                                <div className='flex space-x-1'>
                                    <button
                                        type="button"
                                        className="flex text-M rounded-full focus:ring-4 focus:ring-gray-300 dark:focus:ring-gray-600"
                                        aria-expanded="false"
            ...
            <div className="p-4 sm:ml-64">
                <div className="p-4 border-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700 mt-14 flex flex-col-reverse" style={{ height: 'calc(100vh - 60px)' }}>
                    <div className="flex items-center justify-between">
                        <textarea
